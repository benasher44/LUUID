/*
 Original for Swift.UUID from https://swift.org/LICENSE.txt
...
/*
 ...
 Original copyright information for Swift.UUID from https://github.com/apple/swift/blob/95e49da5d4d3d303203a0b6896ed62e4f7fd84f7/stdlib/public/SDK/Foundation/UUID.swift
 ...
 */
//
//  Changes made by Ben Asher on 10/28/2018
//    - uuidString uses uuid_unparse_lower instead of uuid_unparse to make
//      LUUID conform to RFC (prints lowercase characters instead of uppercase),
//      which has impacts on serialization
//    - Removed ReferenceConvertible conformance and related functions
//      (unavailable to code outside the Swift standard library)
//    - Removed implementation of hashValue and Implemented hash(into:) instead,
//      due to not being able to access CFHashBytes, which is only available
